...
"use strict";
	...
	**/
	function CreateMapDescription() {
		...
		switch(g_map) {
			case "ancient":
				url = "http://localhost:process.env.PORT?map=ancient&mode=mapdescription"
				break;

			case "medieval":
				url = "http://localhost:process.env.PORT?map=medieval&mode=mapdescription"
				break;
			case "earlymodern":
				url = "http://localhost:process.env.PORT?map=earlymodern&mode=mapdescription"
				break;
			default:
				break;
		}	
	...
	**/
	function CreateHighlights() {
		...
		switch(g_map) {
			case "ancient":
				url = "http://localhost:process.env.PORT?map=ancient&mode=coords"				
				break;
				
			case "medieval":
				url = "http://localhost:process.env.PORT?map=medieval&mode=coords"
				break
				
			case "earlymodern":
				url = "http://localhost:process.env.PORT?map=earlymodern&mode=coords"
				break;
	...
	**/
	function CreateCivInfo() {
		...
		let url = "http://localhost:process.env.PORT?map=" + g_map + "&mode=info&civ=" + g_civ;
